export const TRANSLATIONS = {
  fr: {
    ...
    onboarding_bank_account_subtitle: "Crée un compte pour ton patrimoine, et connecte-le en lecture seule si tu veux — Pairwise peut uniquement lire ton solde, jamais interagir avec ton compte.",
    onboarding_bank_account_default_name: "Compte courant",
    onboarding_bank_account_balance_placeholder: "Solde actuel (optionnel)",
    onboarding_bank_account_create: "Créer mon compte",
    onboarding_bank_connect_hint: "Optionnel — connecte ta banque pour garder ce solde à jour automatiquement.",
  ...
  en: {
    ...
    onboarding_bank_account_subtitle: "Create an account for your wealth tracking, and optionally connect it read-only — Pairwise can only read your balance, never interact with your account.",
    onboarding_bank_account_default_name: "Checking account",
    onboarding_bank_account_balance_placeholder: "Current balance (optional)",
    onboarding_bank_account_create: "Create my account",
    onboarding_bank_connect_hint: "Optional — connect your bank to keep this balance up to date automatically.",
