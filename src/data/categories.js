...
// Catalogue de devises : déplacé dans data/currencies.js (la liste complète est
// volumineuse). Ré-exporté ici pour que les imports existants continuent de
// fonctionner sans modification.
export { CURRENCIES, ALL_CURRENCIES, findCurrency, currencySymbolOf } from "./currencies";
